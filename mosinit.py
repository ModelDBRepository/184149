'''
Current clamp demo using Allen Brain's model 329322394.
...
from neuron329322394 import Neuron329322394
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron329322394(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 329322394; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-87.0689697266)
        h.fcurrent()
